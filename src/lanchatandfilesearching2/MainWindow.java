...
import searchFiles.HandleSearchFiles;
...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lan Chat and File Searching");
        ...
        searchFilesButton.setText("search files");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addComponent(searchFilesButton)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
    ...
    private void searchFilesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchFilesButtonActionPerformed
        searchFilesButton.setEnabled(false);
        new Thread() {
            public void run() {
                try {
                    new HandleSearchFiles().doInBackground();
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public static javax.swing.JButton searchFilesButton;
